...
export class RtagConnection {
  ...
  public setDirection(request: ISetDirectionRequest): Promise<Response> {
    return this.callMethod(Method.SET_DIRECTION, ISetDirectionRequest.encode(request).toBuffer());
  }
