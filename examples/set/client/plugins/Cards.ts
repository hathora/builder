...
export default class Cards extends LitElement {
    ...
    static get styles() {
        ...
        .REDPARTIAL {
            background: -webkit-linear-gradient(red, white, red, white, red, white, red, white, red, white, red, white, red, white, red, white, red, white);
        ...
        .GREENPARTIAL {
            background: -webkit-linear-gradient(green, white, green, white, green, white, green, white, green, white, green, white, green, white, green, white, green, white);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;    
        }
        .GREENFULL {
        ...
        .PURPLEPARTIAL {
            background: -webkit-linear-gradient(purple, white, purple, white, purple, white, purple, white, purple, white, purple, white, purple, white, purple, white, purple, white);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;    
        }
        .PURPLEFULL {
