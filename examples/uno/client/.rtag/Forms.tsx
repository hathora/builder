  ...
  return (
    <div className="gap-2 p-2 ml-2 border border-gray-300 rounded-md">
      <div className="col-span-6 sm:col-span-4">
        ...
        <ArrayInput<Card> value={ value.hand } update={(v) => update({ ...value, hand: v })} initialVal={ Card.default() }>
          {(value, update) =>
      ...
      <div className="col-span-6 sm:col-span-4">
        ...
        <OptionalInput<Card> value={ value.pile } update={(v) => update({ ...value, pile: v })} initialVal={ Card.default() }>
          {(value, update) =>
            <CardInput value={value} update={update} />
          }
        </OptionalInput>
      ...
      <div className="col-span-6 sm:col-span-4">
        ...
        <OptionalInput<UserId> value={ value.winner } update={(v) => update({ ...value, winner: v })} initialVal={ "" }>
          {(value, update) =>
            <StringInput value={value} update={update} />
          }
        </OptionalInput>
