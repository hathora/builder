    ...
    <>
      {!isCollapsed ? (
        <div className="p-1 m-1 bg-white border rounded object-display">
          ...
          <KVDisplay label="hand">
            <ArrayDisplay<Card> value={ value.hand }>
              {(value) => 
          ...
          <KVDisplay label="turn">
            <UserIdDisplay value={ value.turn } />
          </KVDisplay>
          <KVDisplay label="pile">
            <OptionalDisplay<Card> value={ value.pile }>
              {(value) => 
                <PluginDisplay value={value} component="card-plugin" isCollapsible={ true } />
              }
            </OptionalDisplay>
          </KVDisplay>
          <KVDisplay label="winner">
            <OptionalDisplay<UserId> value={ value.winner }>
              {(value) => 
                <UserIdDisplay value={value} />
              }
            </OptionalDisplay>
