...
window.customElements.define("card-plugin", CardPlugin);
    ...
    <>
      {!isCollapsed ? (
        <div className="p-1 m-1 bg-white border rounded object-display">
          ...
          <KVDisplay label="chipCount">
            <IntDisplay value={ value.chipCount } />
          </KVDisplay>
          <KVDisplay label="chipsInPot">
            <IntDisplay value={ value.chipsInPot } />
          </KVDisplay>
          <KVDisplay label="cards">
            <ArrayDisplay<Card> value={ value.cards }>
              {(value) => 
                <PluginDisplay value={value} component="card-plugin" isCollapsible={ true } />
              }
            </ArrayDisplay>
          </KVDisplay>
          <KVDisplay label="status">
            <EnumDisplay value={ value.status } enum={ PlayerStatus } />
          </KVDisplay>
        </div>
      ) : (
        <div className="p-1 m-1 bg-white border rounded object-display">
    ...
    <>
      {!isCollapsed ? (
        <div className="p-1 m-1 bg-white border rounded object-display">
          ...
          <KVDisplay label="dealer">
            <UserIdDisplay value={ value.dealer } />
          </KVDisplay>
          <KVDisplay label="activePlayer">
            <UserIdDisplay value={ value.activePlayer } />
          </KVDisplay>
          <KVDisplay label="revealedCards">
            <ArrayDisplay<Card> value={ value.revealedCards }>
              {(value) => 
                <PluginDisplay value={value} component="card-plugin" isCollapsible={ true } />
              }
            </ArrayDisplay>
