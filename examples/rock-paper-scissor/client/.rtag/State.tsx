    ...
    <>
      {!isCollapsed ? (
        <div className="p-1 m-1 bg-white border rounded object-display">
          ...
          <KVDisplay label="gesture">
            <OptionalDisplay<Gesture> value={ value.gesture }>
              {(value) => 
                <EnumDisplay value={value} enum={ Gesture } />
              }
            </OptionalDisplay>
          </KVDisplay>
        </div>
    ...
    <>
      {!isCollapsed ? (
        <div className="p-1 m-1 bg-white border rounded object-display">
          ...
          <KVDisplay label="round">
            <IntDisplay value={ value.round } />
          </KVDisplay>
          <KVDisplay label="player1">
            <PlayerInfoDisplay value={ value.player1 } isCollapsible={ true } />
          </KVDisplay>
          <KVDisplay label="player2">
            <OptionalDisplay<PlayerInfo> value={ value.player2 }>
              {(value) => 
