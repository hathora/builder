...
export class RtagConnection {
  ...
  public chooseGesture(request: IChooseGestureRequest): Promise<Response> {
    return this.callMethod(Method.CHOOSE_GESTURE, IChooseGestureRequest.encode(request).toBuffer());
  }

  public nextRound(request: INextRoundRequest): Promise<Response> {
    return this.callMethod(Method.NEXT_ROUND, INextRoundRequest.encode(request).toBuffer());
  }
