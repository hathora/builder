...
export class RtagConnection {
  ...
  public proposeQuest(request: IProposeQuestRequest): Promise<Response> {
    return this.callMethod(Method.PROPOSE_QUEST, IProposeQuestRequest.encode(request).toBuffer());
  }

  public voteForProposal(request: IVoteForProposalRequest): Promise<Response> {
    return this.callMethod(Method.VOTE_FOR_PROPOSAL, IVoteForProposalRequest.encode(request).toBuffer());
  }

  public voteInQuest(request: IVoteInQuestRequest): Promise<Response> {
    return this.callMethod(Method.VOTE_IN_QUEST, IVoteInQuestRequest.encode(request).toBuffer());
  }
