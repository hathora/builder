...
import { ICreateRoomRequest } from "./types";
      ...
      <div className="flex items-center justify-between h-16 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex items-center">
          ...
          <div className="flex items-center flex-shrink-0 cursor-pointer" onClick={() => navigate(`/`)}>
            <span className="mt-1 ml-3 text-2xl font-semibold text-white uppercase font-display">chat</span>
          </div>
          {user && (
            <div className="block">
...
function Home({ onConnect }: { onConnect: (request: ICreateRoomRequest) => void }) {
