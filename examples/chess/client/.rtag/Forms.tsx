...
function PieceInput({ value, update }: BaseProps<Piece>) {
  return (
    <div className="gap-2 p-2 ml-2 border border-gray-300 rounded-md">
      <div className="col-span-6 sm:col-span-4">
        ...
        <EnumInput value={ value.color } update={(v) => update({ ...value, color: v })} enumType={ Color } />
      </div>
      <div className="col-span-6 sm:col-span-4">
        <label className="block mb-1 text-sm font-medium text-gray-700">type</label>
        <EnumInput value={ value.type } update={(v) => update({ ...value, type: v })} enumType={ PieceType } />
      </div>
      <div className="col-span-6 sm:col-span-4">
  ...
  return (
    <div className="gap-2 p-2 ml-2 border border-gray-300 rounded-md">
      <div className="col-span-6 sm:col-span-4">
        ...
        <ArrayInput<Piece> value={ value.board } update={(v) => update({ ...value, board: v })} initialVal={ Piece.default() }>
          {(value, update) =>
            <PieceInput value={value} update={update} />
          }
        </ArrayInput>
      </div>
      <div className="col-span-6 sm:col-span-4">
      ...
      <div className="col-span-6 sm:col-span-4">
        <label className="block mb-1 text-sm font-medium text-gray-700">opponent</label>
        <OptionalInput<UserId> value={ value.opponent } update={(v) => update({ ...value, opponent: v })} initialVal={ "" }>
          {(value, update) =>
