...
After creating the above file in your directory, run `rtag init` to initialize your project.  You can `rtag dev`, for the following debug view which is automatically generated:
